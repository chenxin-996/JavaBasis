# JavaBasis
Java零基础系统学习之Java基础语法学习

为了初学者更好地学习和查找知识点，项目文件以   _数字   开头来命名，但是学习者应该牢记标识符规范。
...
学完上述Java内容后，在掌握基本语法的基础上，建议多做练习，不断实践和总结。

接下来深入学习如何使用Java进行面向对象编程，掌握类、对象、继承、多态等概念，进一步提高程序的可重用性、可维护性和可扩展性。